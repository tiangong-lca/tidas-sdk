...
class WrapperGenerator:
    ...
    PYTHON_KEYWORDS = {
        ...
        "global", "nonlocal", "lambda", "yield", "break", "continue",
        "pass", "raise", "assert", "del", "in", "is", "not", "and",
        "or", "None", "True", "False"
    }
    ...
    def generate_multilang_property(
        ...
        Returns:
            List of code lines
        """
        description = field_schema.get("description", f"Access {field_name} multi-language field")
    ...
    def generate_nested_property(
        ...
        Returns:
            List of code lines
        """
        description = field_schema.get("description", f"Access {field_name} nested object")
    ...
    def generate_wrapper_class(
        ...
        for field_name, nested_schema in properties.items():
            ...
            if self.is_multi_lang_field(nested_schema):
                lines.extend(
                    self.generate_multilang_property(field_name, python_name, nested_schema)
                )
