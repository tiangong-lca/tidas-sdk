"""
TidasFlowproperties entity wrapper class for TIDAS SDK. Automatically generated by generate_entity_models.py script. Do not edit this file manually.
...
class TidasFlowproperties(TidasEntity):
    ...
    def to_pydantic(self) -> FlowpropertiesModel:
    ...
    @classmethod
    def from_pydantic(cls, model: FlowpropertiesModel) -> 'TidasFlowproperties':
