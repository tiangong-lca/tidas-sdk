"""
TidasProcesses entity wrapper class for TIDAS SDK. Automatically generated by generate_entity_models.py script. Do not edit this file manually.
...
class TidasProcesses(TidasEntity):
    ...
    def processes_data_set(self) -> ProcessesDataSetWrapper:
        ...
        Example:
            ...
            >>> processes.processes_data_set.process_information.data_set_information.uuid = "..."
        """
        return self._get_typed_field("processDataSet", ProcessesDataSetWrapper)

    def to_pydantic(self) -> ProcessesModel:
    ...
    @classmethod
    def from_pydantic(cls, model: ProcessesModel) -> 'TidasProcesses':
