...
class DatasetinformationClassificationinformationCommonClassification(TidasBaseModel):
    ...
    common_class: CommonClassificationCommonClassoption1 | list[CommonClassificationCommonClassoption0itemoption0 | CommonClassificationCommonClassoption0itemoption1] = Field(default=..., alias='common:class')
...
class ContactdatasetContactinformationDatasetinformation(TidasBaseModel):
    ...
    telefax: str | None = Field(default=None, alias='telefax')
    w_w_w_address: str | None = Field(default=None, alias='WWWAddress', description='Web-address of the person, working group, organisation or database network.')
