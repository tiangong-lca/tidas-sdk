...
export class TidasSource extends TidasEntity<Source> {
  ...
  protected initializeDefaults(): void {
    ...
    this.setNestedValue(
      'sourceDataSet.@xmlns',
      'http://lca.jrc.it/ILCD/Source'
    );
    this.setNestedValue(
      'sourceDataSet.@xmlns:common',
      'http://lca.jrc.it/ILCD/Common'
    );
    this.setNestedValue(
      'sourceDataSet.@xmlns:xsi',
      'http://www.w3.org/2001/XMLSchema-instance'
    );
    this.setNestedValue('sourceDataSet.@version', '1.1');
    this.setNestedValue(
      'sourceDataSet.@xsi:schemaLocation',
    ...
    if (
      !this.getNestedValue(
        'sourceDataSet.administrativeInformation.dataEntryBy.common:timeStamp'
      )
    ) {
      this.setNestedValue(
        'sourceDataSet.administrativeInformation.dataEntryBy.common:timeStamp',
    ...
    if (
      !this.getNestedValue(
        'sourceDataSet.administrativeInformation.publicationAndOwnership.common:dataSetVersion'
      )
    ) {
      this.setNestedValue(
        'sourceDataSet.administrativeInformation.publicationAndOwnership.common:dataSetVersion',
    ...
    if (
      !this.getNestedValue(
        'sourceDataSet.administrativeInformation.dataEntryBy.common:referenceToDataSetFormat'
      )
    ) {
      this.setNestedValue(
        'sourceDataSet.administrativeInformation.dataEntryBy.common:referenceToDataSetFormat',
    ...
    if (
      !this.getNestedValue(
        'sourceDataSet.administrativeInformation.publicationAndOwnership.common:referenceToOwnershipOfDataSet'
      )
    ) {
      this.setNestedValue(
        'sourceDataSet.administrativeInformation.publicationAndOwnership.common:referenceToOwnershipOfDataSet',
    ...
    if (
      !this.getNestedValue(
        'sourceDataSet.sourceInformation.dataSetInformation.classificationInformation.common:classification'
      )
    ) {
      this.setNestedValue(
        'sourceDataSet.sourceInformation.dataSetInformation.classificationInformation.common:classification',
    ...
    if (
      !this.getNestedValue(
        'sourceDataSet.administrativeInformation.publicationAndOwnership.common:copyright'
      )
    ) {
      this.setNestedValue(
        'sourceDataSet.administrativeInformation.publicationAndOwnership.common:copyright',
    ...
    if (
      !this.getNestedValue(
        'sourceDataSet.administrativeInformation.publicationAndOwnership.common:accessRestrictions'
      )
    ) {
      this.setNestedValue(
        'sourceDataSet.administrativeInformation.publicationAndOwnership.common:accessRestrictions',
