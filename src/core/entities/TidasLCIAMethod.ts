...
export class TidasLCIAMethod extends TidasEntity<LCIAMethod> {
  constructor(
    initialData?: Partial<LCIAMethod>,
  ...
  protected initializeDefaults(): void {
    ...
    this.setNestedValue(
      'LCIAMethodDataSet.@xmlns',
      'http://lca.jrc.it/ILCD/LCIAMethod'
    );
    this.setNestedValue(
      'LCIAMethodDataSet.@xmlns:common',
      'http://lca.jrc.it/ILCD/Common'
    );
    this.setNestedValue(
      'LCIAMethodDataSet.@xmlns:xsi',
      'http://www.w3.org/2001/XMLSchema-instance'
    );
    this.setNestedValue('LCIAMethodDataSet.@version', '1.1');
    this.setNestedValue(
      'LCIAMethodDataSet.@xsi:schemaLocation',
    ...
    if (
      !this.getNestedValue(
        'LCIAMethodDataSet.administrativeInformation.dataEntryBy.common:timeStamp'
      )
    ) {
      this.setNestedValue(
        'LCIAMethodDataSet.administrativeInformation.dataEntryBy.common:timeStamp',
    ...
    if (
      !this.getNestedValue(
        'LCIAMethodDataSet.LCIAMethodInformation.dataSetInformation.common:name'
      )
    ) {
      this.setNestedValue(
        'LCIAMethodDataSet.LCIAMethodInformation.dataSetInformation.common:name',
    ...
    if (
      !this.getNestedValue(
        'LCIAMethodDataSet.LCIAMethodInformation.dataSetInformation.common:shortName'
      )
    ) {
      this.setNestedValue(
        'LCIAMethodDataSet.LCIAMethodInformation.dataSetInformation.common:shortName',
    ...
    if (
      !this.getNestedValue(
        'LCIAMethodDataSet.LCIAMethodInformation.dataSetInformation.common:synonyms'
      )
    ) {
      this.setNestedValue(
        'LCIAMethodDataSet.LCIAMethodInformation.dataSetInformation.common:synonyms',
    ...
    if (
      !this.getNestedValue(
        'LCIAMethodDataSet.LCIAMethodInformation.dataSetInformation.common:generalComment'
      )
    ) {
      this.setNestedValue(
        'LCIAMethodDataSet.LCIAMethodInformation.dataSetInformation.common:generalComment',
    ...
    if (
      !this.getNestedValue(
        'LCIAMethodDataSet.administrativeInformation.publicationAndOwnership.common:accessRestrictions'
      )
    ) {
      this.setNestedValue(
        'LCIAMethodDataSet.administrativeInformation.publicationAndOwnership.common:accessRestrictions',
