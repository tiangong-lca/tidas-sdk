...
export class TidasUnitGroup extends TidasEntity<UnitGroup> {
  ...
  protected initializeDefaults(): void {
    ...
    this.setNestedValue(
      'unitGroupDataSet.@xmlns',
      'http://lca.jrc.it/ILCD/UnitGroup'
    );
    this.setNestedValue(
      'unitGroupDataSet.@xmlns:common',
      'http://lca.jrc.it/ILCD/Common'
    );
    this.setNestedValue(
      'unitGroupDataSet.@xmlns:xsi',
      'http://www.w3.org/2001/XMLSchema-instance'
    );
    this.setNestedValue('unitGroupDataSet.@version', '1.1');
    this.setNestedValue(
      'unitGroupDataSet.@xsi:schemaLocation',
    ...
    if (
      !this.getNestedValue(
        'unitGroupDataSet.administrativeInformation.dataEntryBy.common:timeStamp'
      )
    ) {
      this.setNestedValue(
        'unitGroupDataSet.administrativeInformation.dataEntryBy.common:timeStamp',
